...
export default {
  ...
  methods: {
    getProducts(page = 1) {
      ...
      const api = `${process.env.APIPATH}/api/${process.env.LINEUPPATH}/admin/products?page=${page}`;
    ...
    updateProduct() { //create新增　或　update更新
      ...
      let api = `${process.env.APIPATH}/api/${process.env.LINEUPPATH}/admin/product`; //create　的API

      let httpMethod = 'post'; //create　的方法

      if (!vm.isNew) { //如果不是要”create”，"編輯"的 API 和 httpMethod 會改變
        // api = `${process.env.APIPATH}/api/${process.env.CUSTOMPATH}/admin/product/${vm.tempProduct.id}`;
        api = `${process.env.APIPATH}/api/${process.env.LINEUPPATH}/admin/product/${vm.tempProduct.id}`;
    ...
    uploadFile() {
      ...
      const url = `${process.env.APIPATH}/api/${process.env.LINEUPPATH}/admin/upload`;
    ...
    delProduct() {
      ...
      const url = `${process.env.APIPATH}/api/${process.env.LINEUPPATH}/admin/product/${vm.tempProduct.id}`;
